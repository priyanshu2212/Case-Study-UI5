		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Admin",
									"targetURL": "#adminbusbooking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"adminbusbooking-display": {
								"semanticObject": "adminbusbooking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=adminbusbooking",
									"url": sap.ui.require.toUrl("adminbusbooking")
								}
							}
						}
					}
